    ...
    <div class="row mt-5 mb-5">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                ...
                data-attr="{{ route('admins.create') }}" title="Tambah Data"> <i class="fas fa-plus-circle"></i>
                </a>
            </div>
        </div>
    </div>
