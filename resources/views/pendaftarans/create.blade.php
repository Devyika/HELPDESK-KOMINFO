            ...
            <div class="col-md-12">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h6 class="text-center">MASUKKAN DATA WEBSITE DENGAN BENAR</h6>
                    </div>
                    <div class="card-body">   
     ...
     <div class="row p-4 ">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="token" class="form-control" placeholder="id google analytic">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 ">
            <div class="form-group">
                <strong>FILE JSON</strong>
                <input type="file" name="file" class="form-control" placeholder="file json">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>STATUS WEBSITE</strong><br>
