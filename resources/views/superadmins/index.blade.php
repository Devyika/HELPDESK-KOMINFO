    ...
    <div class="row mt-3 mb-3">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                ...
                data-attr="{{ route('superadmins.create') }}" title="Tambah Data"> <i class="fas fa-plus-circle"></i>
                </a>
            </div>
        </div>
    </div>
